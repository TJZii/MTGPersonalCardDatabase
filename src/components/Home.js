...
const Home = () => {
    ...
    return (
        <div>
            ...
            <p>This site lets you look at your current collection of cards, (I start you off with 4 from my own collection, including one custom). </p>
            <p>The links to the other pages can be found at the top of each page. </p>
